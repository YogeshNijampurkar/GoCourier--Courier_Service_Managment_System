...
const PaymentOtp = (props) => {
    ...
    useEffect(()=>{
        if(response){
          ...
          sessionStorage.removeItem("courierPayId")
        ...
        <MDBCol md='6'>
          ...
          >
            <div className='text-white rgba-stylish-strong py-5 px-5 z-depth-4'>
              ...
              <MDBInput onChange={(e)=>{setOtp(e.target.value)}}
                label='Enter OTP'
                group
                type='number'
                validate
              ...
              <MDBRow className='d-flex align-items-center mb-4'>
                <div className='text-center mb-3 col-md-12'>
                  <MDBBtn
                    ...
                    rounded
                    type='button'
                    className='btn-block z-depth-1'onClick={onaddotp}
                  >
                    Submit
                  </MDBBtn>
                </div>
                {otp1.loading &&<div>waiting for result</div>}
                {response=="Successfull" && <img src="http://www.shikharclasses.in/wp-content/uploads/2020/04/PAYMENT-SUCCESS.png" ></img>}
              {response=="failed" && <img src="https://campus2community.org/wp-content/uploads/2019/08/Paymentfailedforweb.png"></img>}
              </MDBRow>
              <div>
